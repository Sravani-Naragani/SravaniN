...
<jsp:useBean id="beanDao" class="com.infinite.lmswebhib.EmployDAO"/>
<jsp:useBean id="leaveDao" class="com.infinite.lmswebhib.LeaveHistoryDAO"/>
...
<jsp:useBean id="beanleave" class="com.infinite.lmswebhib.LeaveHistoryDAO"/>
