...
<jsp:useBean id="beanDao" class="com.infinite.hotel.HotelDetailsDAO" />
    <form method="post" action="CustomerLogin.jsp">
        ...
        <div style="color:black;">
           ...
           <div style="color:black;"> UserId:<input type="text" name="userId" size="30" /><br /> </div>
           
           <div style="color:black;">
            <br /> Password:<input type="password" name="pass" size="30" /><br /> </div>
   ...
   <c:if test="${param.userId != null && param.pass != null}">
        <jsp:useBean id="login" class="com.infinite.hotel.CustomerDetails"/>
         ...
         <c:if test="${count==1}">
       <center>  <a href="ShowHotel.jsp"><input type =submit value= SHOWHOTEL ></a>   </center>  
         </c:if>
         <c:if test="${count==0}">
