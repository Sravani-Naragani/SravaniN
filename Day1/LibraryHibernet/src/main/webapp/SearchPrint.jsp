...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="com.infinite.libraryhibernet.Books" %>
    <%@ page import="java.util.List" %>
     <%@ page import="com.infinite.libraryhibernet.LibraryDAO" %>
...
<body>
	...
	<jsp:useBean id="beanDao" class="com.infinite.libraryhibernet.LibraryDAO"/>
